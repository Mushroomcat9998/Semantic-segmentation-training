...
def main(args):
    ...
    if args.resume:
        ...
        if not args.test_only:
            ...
            current_mean_iou = checkpoint["mean_iou"]
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        print("MeanIoU:", confmat.mean_iou)
        if args.amp:
            checkpoint["scaler"] = scaler.state_dict()
        if confmat.mean_iou > current_mean_iou:
            utils.save_on_master(checkpoint, os.path.join(args.output_dir, "best.pth"))
            current_mean_iou = confmat.mean_iou
        utils.save_on_master(checkpoint, os.path.join(args.output_dir, "last.pth"))
